...
void AShinedownHUD::BeginPlay()
{
	Super::BeginPlay();
	AddCharacterOverlay();
}

void AShinedownHUD::AddCharacterOverlay()
{
...
void AShinedownHUD::DrawCrosshair(UTexture2D* Texture, FVector2D ViewportCenter, FVector2D Spread)
{
